...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6331201481').split()] # Replace with the actual admin ID(s) to add
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003272786106'))  # Notification of sent to your channel
...
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Unknown_5557') # Owner link for the bot
